...
const Hobbies = () => {
    ...
    const fetchHobbies = async () => {
        try {
            const url = `${API}/api/hobby/showhobby`;
            const response = await axios.get(url);
            console.log('Fetched hobbies:', response.data);
            // Check if response data is an array (expected)
    ...
    const addHobby = async () => {
        ...
        try {
            const url = `${API}/api/hobby/addhobby`;
            ...
            // Check if result data has expected format
            if (result.data && result.data._id && result.data.name) {
                // Add the new hobby to the list
                setHobbies([...hobbies, result.data]);
                setInputValue('');
            } else {
                console.error('Unexpected response data format:', result.data);
            }
    ...
    const deleteHobby = async (id) => {
        try {
            const url = `${API}/api/hobby/deletehobby/${id}`;
